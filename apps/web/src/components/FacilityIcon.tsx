...
export function FacilityIcon({ type }: FacilityIconProps) {
  if (type === 'water') {
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path
          d="M12 2.8C9.7 6.2 6.2 9.4 6.2 14a5.8 5.8 0 0 0 11.6 0C17.8 9.4 14.3 6.2 12 2.8Z"
          fill="currentColor"
        />
        <path
          d="M9.4 14.2c.2 1.5 1.2 2.4 2.8 2.7"
          fill="none"
          stroke="white"
          strokeLinecap="round"
          strokeWidth="1.7"
  ...
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M12 3v18" fill="none" stroke="currentColor" strokeWidth="1.2" opacity=".45" />
    </svg>
  )
}
