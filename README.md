...
- [x] 로컬 러닝 기록 저장 초안
- [x] 러닝 기록 목록과 상세 초안
- [x] ID/PW 회원가입·로그인 화면 초안
- [x] Supabase Auth 클라이언트 연결과 세션/로그아웃 준비
- [x] 인증 실패·중복 ID 응답 사용자 메시지 정리
- [x] 로그인 사용자별 로컬 러닝 기록 분리
