...
1. iPhone 실기기에서 `iPhone 지도 열기` 버튼을 눌러 NativeMap 화면, 현재 위치, 시설 마커를 확인한다.
...
- `NativeMap`은 React가 현재 위치와 화면에 표시 중인 시설 최대 300개를 Swift `MKMapView` 화면으로 넘기는 구조로 시작했다.
...
- [ ] NativeMap Capacitor plugin 초안 추가
