...
- [x] D3 기반 최근 4개월 거리 그래프, 목표 대비 비교 그래프, Goals 요약 그래프, 월 이동 러닝 날짜 달력 표시
...
- 구현 기능: 총 뛴 거리, 러닝 횟수, 최근 러닝, 월간 거리, 최장 러닝 거리, 평균 페이스, 목표 설정, 주간·월간 목표 대비 진행률, D3 월간 거리 그래프, D3 목표 대비 비교 그래프, Goals 요약 그래프, 월 이동 달력 기반 러닝 날짜 표시.
...
- [x] 마이 페이지 Goals 섹션 D3 요약 차트와 월 이동 달력 추가
