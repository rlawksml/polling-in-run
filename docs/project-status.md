...
Polling In Run은 현재 지도 기반 편의시설 탐색, 러닝 기록 MVP, 로컬 대시보드, 기록 페이지 확장, Capacitor iOS Preview 기본 설정, 홈 화면 Apple MapKit 대체 초안까지 완료했고, 방향을 local-first iPhone prototype으로 재정의한 상태다.
